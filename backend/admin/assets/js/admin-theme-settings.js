  ...
  $(addButton2).on('click', function() {
      ...
      if (x2 < maxField2) {
          ...
          var fieldHTML2 = `<div class='row'>
                          <div class="col-md-5">
                          <br>
                          <textarea required class="form-control" name="asked[${count2}][question]" placeholder="Key" cols="30" rows="4"></textarea>
                          </div>
                          <div class="col-md-6">
                              <br>
                              <textarea required class="form-control" name="asked[${count2}][answer]" placeholder="Value" cols="30" rows="4"></textarea>
                          </div>
                          <div class="col-md-1">
