...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vcard/business/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vcard/business/css/font.css') }}">
    <link rel="stylesheet" href="{{ asset('vcard/business/css/default.css') }}">
    <link rel="stylesheet" href="{{ asset('vcard/business/css/style.css') }}">
</head>
                    ...
                    <div class="col-lg-6 offset-lg-3 p-0">
                        <div class="single-vcard">
                            ...
                            <div class="social-links">
                                ...
                                <a href="{{ vcardlink($social->field_name,$social->value) }}">
