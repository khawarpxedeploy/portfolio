...
<head>
    ...
    <!-- CSS here -->
    <link rel="stylesheet" href="{{ asset('main/installer/css/installer/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('main/installer/css/installer/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('main/installer/css/installer/font.css') }}">
    <link rel="stylesheet" href="{{ asset('main/installer/css/installer/default.css') }}">
    <link rel="stylesheet" href="{{ asset('main/installer/css/installer/style.css') }}">
</head>
<body class="install">
    <!--[if lte IE 9]>
    ...
    <script src="{{ asset('main/installer/js/installer/jquery-3.5.1.min.js') }}"></script>
    <script src="{{ asset('main/installer/js/installer/install.js') }}"></script>
</body>
</html>
