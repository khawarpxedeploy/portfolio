...
<head>
    ...
    <!-- css here -->
    <link rel="stylesheet" href="{{ asset('cv/theme4/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('cv/theme4/css/font.css') }}">
    <link rel="stylesheet" href="{{ asset('cv/theme4/css/default.css') }}">
    @stack('css')
</head>
