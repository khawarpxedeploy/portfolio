...
@section('title','Manage CV Languages')

@section('head')
    @include('layouts.backend.partials.headersection',['title'=>'Manage CV Language','button_name'=>'Create New','button_link'=> route('admin.cvlanguage.create')])
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            <form action="{{ route('admin.language.set') }}" method="POST" class="basicform_with_reset">
                @csrf
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        href="{{ route('admin.cvlanguage.edit', $language->id) }}"><i
                                        class="fas fa-pencil-alt text-light mr-2" aria-hidden="true"></i>{{ __('Edit') }}</a>
                                        <a class="btn btn-danger text-light text-gradient px-3 mb-0 delete-confirm" href="javascript:void(0)"
                                        ...
                                        <form class="d-none" id="delete_form_{{ $language->id }}"
                                            action="{{ route('admin.cvlanguage.destroy', $language->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
