				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-4">
						<ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
							...
							<li class="nav-item">
								<a class="nav-link" id="contact-tab4" data-toggle="tab" href="#social-auth" role="tab" aria-controls="driver" aria-selected="false">{{ __('Social Auth') }}</a>
							</li>
					...
					<div class="col-12 col-sm-12 col-md-8">
							<form enctype="multipart/form-data" method="post" class="basicform" action="{{ route('admin.env.store') }}">
								@csrf
						<div class="tab-content no-padding" id="myTab2Content">
							...
							<div class="tab-pane fade" id="subdomain" role="tabpanel" aria-labelledby="profile-tab4">
								...
								<div class="form-group">
									...
									<select name="AUTO_SUBDOMAIN_APPROVE" class="form-control">
										<option value="true" @if(env('AUTO_SUBDOMAIN_APPROVE')===true) selected="" @endif>{{ __('On') }}</option>
										<option value="false" @if(env('AUTO_SUBDOMAIN_APPROVE')===false) selected="" @endif>{{ __('Off') }}</option>
									</select>
								</div>
								<div class="form-group">
									<label>{{ __('Register With Subdomain Type') }}</label>
									<select name="REGISTER_WITH_SUBDOMAIN" class="form-control">
										<option value="true" @if(env('REGISTER_WITH_SUBDOMAIN')===true) selected="" @endif>{{ __('Real Subdomain') }}</option>
										<option value="false" @if(env('REGISTER_WITH_SUBDOMAIN')===false) selected="" @endif>{{ __('Path Based Subdomain') }}</option>
									</select>
								</div>
								<div class="form-group">
							...
							<div class="tab-pane fade" id="social-auth" role="tabpanel" aria-labelledby="profile-tab4">
								<h6>Social Login Settings</h6>
