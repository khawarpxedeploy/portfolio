...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>'Manage Tamplates'])
@endsection
                            ...
                            <tr class="pt-2">
                                ...
                                <td>
                                    ...
                                    <form class="d-none" id="delete_form_{{ $value->id }}"
                                        action="{{ route('admin.template.destroy', $value->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.template.store') }}" class="basicform">
                    @csrf
