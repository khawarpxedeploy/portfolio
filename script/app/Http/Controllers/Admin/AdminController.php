...
class AdminController extends Controller
{
    ...
    {
        abort_if(!Auth()->user()->can('admin.create'), 401);
        $roles = Role::all();
    ...
    {
        //using custom request validator form App\Http\Requests\AdminRequest;
    ...
    {
        abort_if(!Auth()->user()->can('admin.edit'), 401);
        $user  = User::find($id);
        $roles = Role::all();
    ...
    {
        abort_if(!Auth()->user()->can('admin.delete'), 401);
        ...
        return response()->json('Successfully completed your actions');
    }
}
