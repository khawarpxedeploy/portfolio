...
class VCardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.vcard.index', compact('theme'));
    }
        ...
        if (file_exists('uploads/tmp/'.$name.'/function.php')) {
            ...
            if (function_exists('theme_info')) {
                ...
                if (file_exists('uploads/tmp/'.$name.'/function.php')) {
                    ...
                    File::copyDirectory('uploads/tmp/'.$name.'/'.$theme_assets_root, 'vcard');
                    File::copyDirectory('uploads/tmp/'.$name.'/'.$theme_src_root, base_path('resources/views/vcard/'));
